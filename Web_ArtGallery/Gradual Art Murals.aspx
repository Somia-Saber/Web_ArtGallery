...
<body>
    ...
    <ul>
        ...
        <li class="nav-right"><a href="login.aspx" class="active">Login</a></li>
         ...
         <p>
                <asp:Image ID="Image7" runat="server" CssClass="auto-style5" Height="192px" ImageUrl="Image4.jpeg" Width="195px" />
                </p>
        <p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Gradual Art Murals</p>
        <p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Price:1200 EGP</p>
        <p>
            <asp:Button ID="Button1" runat="server" Text="Add to cart" BorderStyle="Solid" CssClass="auto-style6" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="#660033" Height="37px" Width="229px" />
        </p>
         </form>
